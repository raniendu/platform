...
from vikram.agent import VikramAgentRunner, build_agent_runner
...
_agents: dict[str, VikramAgentRunner] = {}
...
def _get_agent(name: str) -> VikramAgentRunner:
...
async def telegram_webhook(
    ...
    if not settings.telegram_webhook_secret:
        raise HTTPException(
            status_code=503,
            detail="VIKRAM_TELEGRAM_WEBHOOK_SECRET is not configured",
        )
