...
validate_platform_env() {
  ...
  for key in PLATFORM_POSTGRES_PASSWORD PREFECT_POSTGRES_PASSWORD AIRFLOW_POSTGRES_PASSWORD PAPERCLIP_POSTGRES_PASSWORD PAPERCLIP_BASIC_AUTH_USER PAPERCLIP_BASIC_AUTH_HASH PAPERCLIP_BETTER_AUTH_SECRET PAPERCLIP_AGENT_JWT_SECRET RAMAN_MODEL_PROVIDER RAMAN_DEV_MODEL DO_INFERENCE_API_KEY TELEGRAM_BOT_TOKEN TELEGRAM_WEBHOOK_SECRET TELEGRAM_ALLOWED_CHAT_IDS RAMAN_PUBLIC_BASE_URL; do
